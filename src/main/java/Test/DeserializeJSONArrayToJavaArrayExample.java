...
public class DeserializeJSONArrayToJavaArrayExample {
	...
	public static void main(String[] args) throws JsonProcessingException {
		 int n;  
	        ...
	        List<Student12> students = new ArrayList<Student12>();  
	        ...
	        for(int i = 0; i < n; i++) {  
	            ...
	            students.add(new Student12(id, name, passed, fail));  
	        ...
	        //objects will be deserialized (that is the Student Type which was added into the List type]
	          
	        // deserialize JSON array into Java Array  
	        Student12[] data = mapper.readValue(jsonArray, Student12[].class);  
	        System.out.println(data.toString());
	          
	        // use for each to iterate Student array  
	        for(Student12 std : data) {  
	            System.out.println("Student Id: "+std.getStdId());  
	            System.out.println("Student Name: "+std.getStdName());  
	            System.out.println("Is "+std.getStdName()+ "pass in exams(Yes/No)?: "+std.getPassed());  
	        }  
